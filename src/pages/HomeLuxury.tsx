...
const HomeLuxury = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section for Luxury - exactly like screenshot */}
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-serif font-bold text-gray-800 leading-tight">
                  Atulya Karigari
                  <br />
                  <span className="text-orange-600">Luxury Collection</span>
                </h1>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Where every thread tells a story of grace. Experience the finest handwoven 
                sarees crafted by master artisans with intricate embroidery and premium materials.
              </p>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl">
                <img 
                  ...
                  alt="Beautiful luxury sarees collection"
